...
class Calculator extends Component {
  ...
  calculateNicVolume() {
    let nicVolume =
      (this.state.batchNic / this.state.baseNic) * this.state.batchVolume
  ...
  calculateBatchNicWeight() {
    let batchNicWeight =
      this.calculateBaseNicWeight() * this.calculateNicVolume()
  ...
  calculatePGVolume() {
    ...
    let volumeTaken = 0
    let nicPGVolume =
      (this.calculateNicVolume() * (100 - this.state.baseRatio)) / 100
  ...
  render() {
    ...
    let saveRecipeButton = this.context.isLoggedIn ? (
      <button className="saveButton" onClick={e => this.saveRecipe()}>
        Save Recipe
      </button>
    ) : null
          ...
          <div className="topSection">
            <div className="leftSection">
              ...
              <Card cardHeader="Flavours">
                {flavourInputList}
                <Button onClick={this.addFlavour.bind(this)} action="add">
                  + Add Flavour
                </Button>
              </Card>
